...
@author: soumi
'''
SKETCH_AREA_THRESHOLD = .001
SKETCH_WIDTH_THRESHOLD =.001
SKETCH_HEIGHT_THRESHOLD =.001
...
MIN_AREA_TO_IGNORE_RATIO_WIDTH_DP = 6
MIN_AREA_TO_IGNORE_RATIO_HEIGHT_DP = 6
...
ATTRIBUTE_ROTATION= "android:rotation"
