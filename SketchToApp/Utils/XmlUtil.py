...
def addRotation(element,  degree) :
    element.set(Constants.ATTRIBUTE_ROTATION, degree)
...
def	  addIconFromResource(element,  iconName) :
    element.set("android:src", getReferenceDrawableId(iconName))	
